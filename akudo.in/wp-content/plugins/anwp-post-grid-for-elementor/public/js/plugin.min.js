(window.anwpPostGridElementor = {}),
  (function (window, $, app, l10n) {
    (app.init = function () {
      ...
      (app.cache = function () {
        app.$c = { body: $(document.body) };
      }),
      (app.bindEvents = function () {
        $(window).on("elementor/frontend/init", function () {
          elementorFrontend.hooks.addAction(
            "frontend/element_ready/anwp-pg-simple-slider.default",
            function ($scope) {
              app.initSwiper($scope);
            }
          ),
            elementorFrontend.hooks.addAction(
              "frontend/element_ready/anwp-pg-flex-slider.default",
              function ($scope) {
                app.initFlexSwiper($scope);
              }
            ),
            elementorFrontend.hooks.addAction(
              "frontend/element_ready/anwp-pg-classic-slider.default",
              function ($scope) {
                app.initSwiper($scope);
              }
            ),
            elementorFrontend.hooks.addAction(
              "frontend/element_ready/anwp-pg-classic-blog.default",
              function ($scope) {
                app.initPagination($scope);
              }
            ),
            elementorFrontend.hooks.addAction(
              "frontend/element_ready/anwp-pg-classic-grid.default",
              function ($scope) {
                app.initPagination($scope);
              }
            ),
            elementorFrontend.hooks.addAction(
              "frontend/element_ready/anwp-pg-light-grid.default",
              function ($scope) {
                app.initPagination($scope);
              }
            ),
            elementorFrontend.hooks.addAction(
              "frontend/element_ready/anwp-pg-simple-grid.default",
              function ($scope) {
                app.initPagination($scope);
              }
            ),
      ...
      (app.initPromotionTooltip = function () {
        ...
        $(parent.document).on("click", function (wrapper) {
          ...
          wrapper.length &&
            wrapper.find(".anwp-pg-pro-promotion-icon").length &&
      ...
      (app.initLoadMore = function () {
        ...
        return (
          !!$btn.length &&
          !$btn
            .closest(".anwp-pg-wrap")
            .find(".anwp-pg-widget-header__has-filters").length &&
          void $btn.on("click", function (e) {
            e.preventDefault();
            var $this = $(this);
            ...
            $this.addClass("anwp-pg-load-more--active disabled"),
              ...
              $.ajax({
                ...
                .done(function (response) {
                  response.success &&
                    ($(response.data.html).appendTo(
                      $this
                        .closest(".anwp-pg-wrap")
                        .find(".anwp-pg-posts-wrapper")
                    ),
      ...
      (app.initSwiper = function ($scope) {
        ...
        "yes" === $slider.data("pg-loop") && (swiperOptions.loop = !0),
          "yes" === $slider.data("pg-autoplay") &&
            (swiperOptions.autoplay = {
              delay: $slider.data("pg-autoplay-delay"),
            }),
          "yes" === $slider.data("pg-enable-observer") &&
            ((swiperOptions.observer = !0),
            (swiperOptions.observeParents = !0)),
          "fade" === swiperOptions.effect &&
            (swiperOptions.fadeEffect = { crossFade: !0 }),
          $scope.find(".swiper-pagination").length &&
            (swiperOptions.pagination = {
              el: ".swiper-pagination",
              type: "bullets",
              clickable: !0,
            }),
          $scope.find(".elementor-swiper-button-prev").length &&
      ...
      (app.initFlexSwiper = function ($scope) {
        ...
        "yes" === $slider.data("pg-autoplay") &&
          ...
          "yes" === $slider.data("pg-loop")
            ? (swiperOptions.loop = !0)
            : (swiperOptions.loop = !1),
          "yes" === $slider.data("pg-free-mode") &&
            (swiperOptions.freeMode = !0),
          "yes" === $slider.data("pg-enable-observer") &&
            ((swiperOptions.observer = !0),
            (swiperOptions.observeParents = !0)),
          $scope.find(".swiper-pagination").length &&
      ...
      (app.initPagination = function ($wrappers) {
        ...
        $wrappers.each(function () {
          var $wrapper = $(this),
            $xhr = null,
            $loader =
              '<img class="anwp-pg-pagination-loader" src="' +
              l10n.loader +
              '" alt="loader">';
          if (
            $wrapper
          ...
          var options = {
              ...
              show_first_ellipsis:
                "yes" === $wrapper.data("anwp-show_first_ellipsis"),
              show_last_ellipsis:
                "yes" === $wrapper.data("anwp-show_last_ellipsis"),
              auto_hide_previous:
                "yes" === $wrapper.data("anwp-auto_hide_previous"),
              auto_hide_next: "yes" === $wrapper.data("anwp-auto_hide_next"),
              total_pages: $wrapper.data("anwp-total"),
              text_previous: $wrapper.data("anwp-text_previous")
                ? $wrapper.data("anwp-text_previous")
                : '<span aria-hidden="true">&laquo;</span>',
              text_next: $wrapper.data("anwp-text_next")
                ? $wrapper.data("anwp-text_next")
              ...
              range_end: 3,
              show_page_numbers:
                "yes" === $wrapper.data("anwp-show_page_numbers"),
            },
            $postsWrapper = $wrapper
              .closest(".anwp-pg-wrap")
              .find(".anwp-pg-posts-wrapper");
          ...
          function renderPagination() {
            ...
            if (options.current_page) {
              if (
                ((options.range_start =
                  options.current_page - options.page_range),
                (options.range_end = options.current_page + options.page_range),
                options.range_end > options.total_pages &&
                  ((options.range_end = options.total_pages),
                  (options.range_start =
                    options.total_pages - 2 * options.page_range),
                  (options.range_start =
                    options.range_start < 1 ? 1 : options.range_start)),
                options.range_start <= 1 &&
                  ((options.range_start = 1),
                  (options.range_end = Math.min(
                    2 * options.page_range + 1,
                    options.total_pages
                  ))),
                options.show_previous &&
                  (options.current_page <= 1
                    ? options.auto_hide_previous ||
                      (html +=
                        '<li class="anwp-page-item"><a class="anwp-page-link anwp-page-link--disabled" href="#">' +
                        options.text_previous +
                        "</a></li>")
                    : (html +=
                        '<li class="anwp-page-item"><a class="anwp-page-link" title="Previous page" data-anwp-number="' +
                        (options.current_page - 1) +
                        '" href="#">' +
                        options.text_previous +
                        "</a></li>")),
                ...
                if (options.range_start <= 3)
                  for (ii = 1; ii < options.range_start; ii++)
                    ii === options.current_page
                      ? (html +=
                          '<li class="anwp-page-item"><a class="anwp-page-link anwp-page-link--active" href="#" data-anwp-number="' +
                          ii +
                          '">>' +
                          ii +
                          "</a></li>")
                      : (html +=
                          '<li class="anwp-page-item"><a class="anwp-page-link" data-anwp-number="' +
                          ii +
                          '" href="#">' +
                          ii +
                          "</a></li>");
                else
                  options.show_first_ellipsis &&
                    (html +=
                      '<li class="anwp-page-item"><a href="#" class="anwp-page-link" data-anwp-number="1">1</a></li>'),
                    (html +=
                      '<li class="anwp-page-item"><a class="anwp-page-link anwp-page-link--disabled">...</a></li>');
                for (ii = options.range_start; ii <= options.range_end; ii++)
                  ii === options.current_page
                    ? (html +=
                        '<li class="anwp-page-item"><a href="#" class="anwp-page-link anwp-page-link--active" data-anwp-number="' +
                        ii +
                        '">' +
                        ii +
                        "</a></li>")
                    : (html +=
                        '<li class="anwp-page-item"><a href="#" class="anwp-page-link" data-anwp-number="' +
                        ii +
                        '">' +
                        ii +
                        "</a></li>");
                if (options.range_end >= options.total_pages - 2)
                  for (
                    ii = options.range_end + 1;
                    ii <= options.total_pages;
                    ii++
                  )
                    html +=
                      '<li class="anwp-page-item"><a href="#" class="anwp-page-link" data-anwp-number="' +
                  ...
                  (html +=
                    '<li class="anwp-page-item"><a href="#" class="anwp-page-link anwp-page-link--disabled">...</a></li>'),
                    options.show_last_ellipsis &&
                      (html +=
                        '<li class="anwp-page-item"><a href="#"  class="anwp-page-link" data-anwp-number="' +
                        options.total_pages +
                        '">' +
              ...
              options.show_next &&
                (options.current_page >= options.total_pages
                  ? options.auto_hide_next ||
                    (html +=
                      '<li class="anwp-page-item"><a class="anwp-page-link anwp-page-link--disabled" href="#">' +
                      options.text_next +
                      "</a></li>")
          ...
          $wrapper.on("click", ".anwp-page-link", function ($this) {
            ...
            $this = $(this);
            if (
              $this.hasClass("anwp-page-link--active") ||
              $this.hasClass("anwp-page-link--disabled")
            )
              return !1;
