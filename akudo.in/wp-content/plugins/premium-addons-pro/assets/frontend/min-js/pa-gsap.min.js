!(function (e, t) {
  ...
  (N.version = "2.0.7"), window.addEventListener("mousewheel", function () {});
  var z = "data-scrollmagic-pin-spacer";
  N.Controller = function (e) {
    function t() {
      if (m && d) {
        var n = I.type.Array(d) ? d : f.slice(0);
        d = !1;
        var e = p,
          t = (p = c.scrollPos()) - e;
        0 != t && (g = 0 < t ? "FORWARD" : s),
    ...
    var n,
      ...
      m = !0,
      y = function () {
        0 < u.refreshInterval && (o = window.setTimeout(x, u.refreshInterval));
      },
      w = function () {
        return u.vertical
      ...
      T = function (e) {
        E(3, "event fired causing an update:", e.type),
          "resize" == e.type && ((v = S()), (g = l)),
          !0 !== d && ((d = !0), i());
      },
      x = function () {
        if (!h && v != S()) {
      ...
      E = (this._log = function (e, t) {
        u.loglevel >= e &&
          (Array.prototype.splice.call(arguments, 1, 0, "(" + r + ") ->"),
    ...
    return (
        ...
        if (I.type.Array(e))
          ...
          if (e.controller() !== c) e.addTo(c);
            ...
            u.globalSceneOptions))
              e[t] && e[t].call(e, u.globalSceneOptions[t]);
      ...
      (this.removeScene = function (e) {
        if (I.type.Array(e))
          ...
          -1 < t &&
            ...
            f.splice(t, 1),
            E(3, "removing Scene (now " + f.length + " left)"),
            e.remove());
        }
        return c;
      }),
      (this.updateScene = function (e, n) {
        return (
          I.type.Array(e)
            ...
            ? e.update(!0)
            : !0 !== d &&
              e instanceof N.Scene &&
              (-1 == (d = d || []).indexOf(e) && d.push(e), (d = R(d)), i()),
          c
        );
      }),
      (this.update = function (e) {
        return T({ type: "resize" }), e && t(), c;
      }),
      (this.scrollTo = function (e, t) {
        if (I.type.Number(e)) b.call(u.container, e, t);
        else if (e instanceof N.Scene)
          e.controller() === c
            ? c.scrollTo(e.scrollOffset(), t)
            : E(
                2,
          ...
          if (n) {
            for (; n.parentNode.hasAttribute(z); ) n = n.parentNode;
            var i = u.vertical ? "top" : "left",
              o = I.get.offset(u.container),
              r = I.get.offset(n);
            h || (o[i] -= c.scrollPos()), c.scrollTo(r[i] - o[i], t);
          } else
            E(
              2,
      ...
      (this.info = function (e) {
        ...
        return arguments.length
          ? void 0 !== t[e]
            ? t[e]
            : void E(1, 'ERROR: option "' + e + '" is not available')
          : t;
      }),
      (this.loglevel = function (e) {
        return arguments.length
          ? (u.loglevel != e && (u.loglevel = e), c)
          : u.loglevel;
      }),
      (this.enabled = function (e) {
        return arguments.length
          ? (m != e && ((m = !!e), c.updateScene(f, !0)), c)
          : m;
      }),
      (this.destroy = function (e) {
        ...
        return (
          ...
          I.cAF(n),
          E(3, "destroyed " + r + " (reset: " + (e ? "true" : "false") + ")"),
          null
        );
      }),
      (function () {
        for (var e in u)
          a.hasOwnProperty(e) ||
            (E(2, 'WARNING: Unknown option "' + e + '"'), delete u[e]);
        if (((u.container = I.get.elements(u.container)[0]), !u.container))
          throw (
            (E(
              1,
        ...
        (u.refreshInterval = I.type.Number(t) ? t : a.refreshInterval),
          y(),
          E(3, "added new " + r + " controller (v" + N.version + ")");
      })(),
      c
    );
  };
  ...
  (N.Controller.addOption = function (e, t) {
    ...
    (N.Scene = function (e) {
        ...
        return (
          I.type.Function(o)
            ? (e = e.trim().split(" ")).forEach(function (e) {
                ...
                "*" != n &&
                  (s[n] || (s[n] = []),
                  s[n].push({ namespace: i || "", callback: o }));
              })
            : m(
                1,
        ...
        (this.trigger = function (e, n) {
          if (e) {
            var t = e.trim().split("."),
              ...
              o = t[1],
              r = s[i];
            m(3, "event fired:", i, n ? "->" : "", n || ""),
              r &&
                r.forEach(function (e, t) {
                  (o && o !== e.namespace) ||
                    e.callback.call(d, new N.Event(i, e.namespace, d, n));
                });
      ...
      var m = (this._log = function (e, t) {
        p.loglevel >= e &&
          (Array.prototype.splice.call(arguments, 1, 0, "(" + i + ") ->"),
          I.log.apply(window, arguments));
      });
      (this.addTo = function (e) {
        return (
          e instanceof N.Controller
            ? a != e &&
              (a && a.removeScene(d),
              (a = e),
              E(),
              ...
              e.addScene(d),
              d.trigger("add", { controller: a }),
              m(3, "added " + i + " to controller"),
              d.update())
            : m(
                1,
        ...
        (this.destroy = function (e) {
          return (
            ...
            d.remove(),
            d.off("*.*"),
            m(3, "destroyed " + i + " (reset: " + (e ? "true" : "false") + ")"),
            null
          );
        }),
        (this.update = function (e) {
        ...
        (this.progress = function (e) {
          if (arguments.length) {
            ...
            if (
              ...
              var r = { progress: h, state: g, scrollDirection: i },
                s = g != n,
                l = function (e) {
                  d.trigger(e, r);
                };
              s && n !== u && (l("enter"), l(n === c ? "start" : "end")),
                l("progress"),
                s && g !== u && (l(g === c ? "start" : "end"), l("leave"));
            }
            return d;
          }
          return h;
      ...
      var y,
        ...
        t = function () {
          (l = { start: v + p.offset }),
            a &&
              p.triggerElement &&
              (l.start -= a.info("size") * p.triggerHook),
            (l.end = l.start + p.duration);
        },
        S = function (e) {
          if (n) {
            var t = "duration";
            R(t, n.call(d)) &&
              !e &&
              (d.trigger("change", { what: t, newval: p[t] }),
          ...
          if (a && (n || 0 < v)) {
            if (n)
              if (n.parentNode) {
                for (
                  var i = a.info(),
                    o = I.get.offset(i.container),
                    r = i.vertical ? "top" : "left";
                  n.parentNode.hasAttribute(z);

                )
                  n = n.parentNode;
                var s = I.get.offset(n);
                i.isDocument || (o[r] -= a.scrollPos()), (t = s[r] - o[r]);
              } else
                m(
                  2,
          ...
          (e = arguments.length ? [e] : Object.keys(x)).forEach(function (
            ...
            if (x[t])
              try {
                ...
                I.type.Array(i)
                  ? ((i[0] = "ERROR: " + i[0]), i.unshift(1), m.apply(this, i))
                  : m(
                      1,
        ...
        R = function (e, t) {
          var n = !1,
            i = p[e];
          return p[e] != t && ((p[e] = t), E(e), (n = i != p[e])), n;
        },
        _ = function (t) {
          d[t] ||
            (d[t] = function (e) {
      ...
      function C() {
        a &&
          ...
          (((w.relSize.width || w.relSize.autoFullWidth) &&
            I.get.width(window) != I.get.width(w.spacer.parentNode)) ||
            (w.relSize.height &&
              I.get.height(window) != I.get.height(w.spacer.parentNode))) &&
          L();
      }
      function O(e) {
        a &&
          ...
          if (y && a) {
            ...
            if (e || g !== u) {
              ...
              w.pushFollowers
                ? 0 < p.duration &&
                  ((g === f &&
                    0 === parseFloat(I.css(w.spacer, "padding-top"))) ||
                    (g === c &&
                      0 === parseFloat(I.css(w.spacer, "padding-bottom")))) &&
                  (o = !0)
                : (i[t.vertical ? "top" : "left"] = p.duration * h),
                I.css(n, i),
                o && L();
            } else {
              "fixed" != I.css(n, "position") &&
                (I.css(n, { position: "fixed" }), L());
              var r = I.get.offset(w.spacer, !0),
                s =
                  p.reverse || 0 === p.duration
                    ? t.scrollPos - l.start
                    : Math.round(h * p.duration * 10) / 10;
              (r[t.vertical ? "top" : "left"] += s),
                I.css(w.spacer.firstChild, { top: r.top, left: r.left });
            }
          }
        },
        L = function () {
          if (y && a && w.inFlow) {
            var e = g === u,
              t = a.info("vertical"),
              n = w.spacer.firstChild,
              i = I.isMarginCollapseType(I.css(w.spacer, "display")),
              o = {};
            w.relSize.width || w.relSize.autoFullWidth
              ? e
                ? I.css(y, { width: I.get.width(w.spacer) })
                : I.css(y, { width: "100%" })
              : ((o["min-width"] = I.get.width(t ? y : n, !0, !0)),
                (o.width = e ? o["min-width"] : "auto")),
              w.relSize.height
                ? e
                  ? I.css(y, {
                      height:
                        I.get.height(w.spacer) -
                        (w.pushFollowers ? p.duration : 0),
                    })
                  : I.css(y, { height: "100%" })
                : ((o["min-height"] = I.get.height(t ? n : y, !0, !i)),
                  (o.height = e ? o["min-height"] : "auto")),
              w.pushFollowers &&
                ((o["padding" + (t ? "Top" : "Left")] = p.duration * h),
      ...
      (this.setPin = function (e, t) {
        ...
        var r = "absolute" != I.css(y, "position"),
          s = I.css(y, o.concat(["display"])),
          l = I.css(y, ["width", "height"]);
        (y.parentNode.style.display = i),
          !r &&
            t.pushFollowers &&
            (m(
              2,
        ...
        if (
          (r || I.extend(c, I.css(y, ["width", "height"])),
          I.css(a, c),
          a.setAttribute(z, ""),
          I.addClass(a, t.spacerClass),
          (w = {
            spacer: a,
            relSize: {
              ...
              autoFullWidth:
                "auto" === l.width && r && I.isMarginCollapseType(s.display),
            },
        ...
        return (
          w.relSize.width && I.css(a, { width: l.width }),
          w.relSize.height && I.css(a, { height: l.height }),
          a.appendChild(y),
          I.css(y, {
            position: r ? "relative" : "absolute",
            margin: "auto",
          ...
          if (y) {
            if ((g === u && k(!0), e || !a)) {
              ...
              w.spacer.parentNode.insertBefore(t, w.spacer),
                ...
                y.parentNode.hasAttribute(z) ||
                  (I.css(y, y.___origStyle), delete y.___origStyle);
            }
      ...
      return (
        ...
        (this.setClassToggle = function (e, t) {
          ...
          return (
            0 !== n.length && I.type.String(t)
              ? (0 < F.length && d.removeClassToggle(),
                (A = t),
                (F = n),
        ...
        (function () {
          for (var e in p)
            o.hasOwnProperty(e) ||
              (m(2, 'WARNING: Unknown option "' + e + '"'), delete p[e]);
          for (var t in o) _(t);
          E();
        })(),
        d
  ...
  var M = {
    ...
    validate: {
      ...
      loglevel: function (e) {
        if (((e = parseInt(e)), !I.type.Number(e) || e < 0 || 3 < e))
  ...
  (N.Scene.addOption = function (e, t, n, i) {
    e in M.defaults
      ? N._util.log(
          1,
      ...
      : ((M.defaults[e] = t), (M.validate[e] = n), i && M.shifts.push(e));
  }),
  ...
  var I = (N._util = (function (s) {
    ...
    function i(e, t, n, i) {
      ...
      else if (!g.DomElement(t)) return 0;
      ...
      if (n && i) {
        ...
        o +=
          "Height" === e
            ? l(r.marginTop) + l(r.marginBottom)
            : l(r.marginLeft) + l(r.marginRight);
      }
      return o;
    }
    function c(e) {
    ...
    var f = ["error", "warn", "log"],
      d = s.console || {};
    for (d.log = d.log || function () {}, n = 0; n < f.length; n++) {
      var p = f[n];
      d[p] || (d[p] = d.log);
    }
    e.log = function (e) {
      ...
      o.unshift(n), r.apply(d, o);
    };
    var g = (e.type = function (e) {
    ...
    (g.String = function (e) {
      ...
      (g.Number = function (e) {
        return !g.Array(e) && 0 <= e - parseFloat(e) + 1;
      }),
      (g.DomElement = function (e) {
        return (
          "DIV" === e.nodeName ||
          ("object" == typeof HTMLElement || "function" == typeof HTMLElement
    ...
    return (
      (h.elements = function (e) {
        ...
        if ("nodelist" === g(e) || g.Array(e) || e instanceof NodeList)
          for (var n = 0, i = (t.length = e.length); n < i; n++) {
            var o = e[n];
            t[n] = g.DomElement(o) ? o : h.elements(o);
          }
        else (!g.DomElement(e) && e !== document && e !== s) || (t = [e]);
        return t;
      }),
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  function s(e, t) {
    var n = "x" === t ? "Width" : "Height",
      ...
      r = document.body;
    return e === u || e === c || e === r
      ? Math.max(c[i], r[i]) - (u["inner" + n] || c[o] || r[o])
      : e[i] - e["offset" + n];
  }
  function a(e, t) {
  ...
  function r(e, t) {
    var n,
      i =
        ("string" == typeof (n = e) && (n = TweenLite.selector(n)),
        n.length && n !== u && n[0] && n[0].style && !n.nodeType && (n = n[0]),
        (n === u || (n.nodeType && n.style)
          ? n
          : null
      ...
      s = r
        ? {
            top:
              c.clientTop -
              (window.pageYOffset || c.scrollTop || o.scrollTop || 0),
            left:
              c.clientLeft -
              (window.pageXOffset || c.scrollLeft || o.scrollLeft || 0),
          }
        : t.getBoundingClientRect(),
      l = { x: i.left - s.left, y: i.top - s.top };
    return !r && t && ((l.x += a(t, "x")()), (l.y += a(t, "y")())), l;
  }
  function i(e, t, n, i) {
    var o = typeof e;
    return isNaN(e)
      ? "string" == o && "=" === e.charAt(1)
        ? parseInt(e.charAt(0) + "1", 10) * parseFloat(e.substr(2)) + i
        : "max" === e
        ? s(t, n)
        : Math.min(s(t, n), r(e, t)[n])
      : parseFloat(e);
  }
  var c = (_gsScope.document || {}).documentElement,
    u = _gsScope,
    l = _gsScope._gsDefine.plugin({
      ...
      set: function (e) {
        ...
        this.x < 0 && (this.x = 0),
          ...
          this._wdw
            ? u.scrollTo(this.skipX ? t : this.x, this.skipY ? n : this.y)
        ...
        var s = function () {
          if (o) {
            ...
            o.repeat && -1 === o.repeat()
              ? "DURING" === t && o.paused()
                ? o.play()
                : "DURING" === t || o.paused() || o.pause()
              : e != o.progress() &&
                (0 === r.duration()
                  ? 0 < e
                    ? o.play()
                    : o.reverse()
                  : r.tweenChanges() && o.tweenTo
                  ? o.tweenTo(e * o.duration())
                  : o.progress(e).pause());
          }
        };
        (r.setTween = function (e, t, n) {
          var i;
          1 < arguments.length &&
            (arguments.length < 3 && ((n = t), (t = 1)), (e = l.to(e, t, n)));
          try {
            (i = a ? new a({ smoothChildTiming: !0 }).add(e) : e).pause();
          } catch (e) {
            return r;
          }
          return (
          ...
          (r.removeTween = function (e) {
            return o && (e && o.progress(0).pause(), o.kill(), (o = void 0)), r;
          });
      });
  });
