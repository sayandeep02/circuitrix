      ...
      return (function (g, i, j, k) {
        ...
        (function () {
          ...
          var a = f.getFbeventsModules("SignalsFBEventsQE"),
            ...
            g = f.getFbeventsModules("SignalsFBEventsBufferConfigTypedef"),
            ...
            k = j.coerce,
            m = j.Typed;
          j = f.getFbeventsModules("SignalsFBEventsOpenBridgeConfigTypedef");
          var o = f.getFbeventsModules(
              "SignalsFBEventsParallelFireConfigTypedef"
            ),
            p = f.getFbeventsModules("signalsFBEventsCoercePixelID"),
            q = f.getFbeventsModules("signalsFBEventsCoerceBatchingConfig"),
      ...
      return (function (g, h, i, j) {
        ...
        (function () {
          ...
          b = {
            ...
            getAemResult: q,
            getClickIDFromBrowserProperties: r,
          };
          k.exports = b;
        })();
        return k.exports;
      ...
      return (function (f, g, h, i) {
        ...
        (function () {
          ...
          j.exports = {
            ...
            RETRIEVE_FBCLID_FROM_BROWSER_PROPERTIES:
              "retrieve_fbclid_from_browser_properties",
          };
        })();
        return j.exports;
              ...
              },
              {
                ...
                value: function (a) {
                  a === "revoke"
                    ...
                    : G({ action: a, type: "INVALID_CONSENT_ACTION" });
                  return this;
                },
              },
              {
              ...
              },
              {
                ...
                value: function (a) {
                  ...
                  a =
                    ...
                    C(a.userDataFormFields).length > 0;
                  return b || a;
                },
              },
              {
          ...
          (function () {
            ...
            a = b.objectWithFields({
              ...
              additionalUserData: b.allowNull(
                b.objectWithFields({ sendFBLoginID: b["boolean"]() })
              ),
            });
            k.exports = a;
          })();
    ...
    f.ensureModuleRegistered("signalsFBEventsSendEvent", function () {
      return (function (g, h, i, j) {
        ...
        (function () {
          ...
          var j = f.getFbeventsModules("signalsFBEventsSendBeacon"),
            l = f.getFbeventsModules("signalsFBEventsSendGET");
          f.getFbeventsModules("signalsFBEventsSendXHR");
          var m = f.getFbeventsModules("signalsFBEventsSendXHRWithRetry"),
          ...
          function x(a) {
            ...
            d.resetExperimentAssigment();
            return a;
          }
          function y(a, b, c, d) {
            a.replaceEntry("rqm", c), m(a, r.ENDPOINT, b, d);
          }
          function z(a) {
            var e =
            ...
            var i = !o(),
              k =
                Object.prototype.hasOwnProperty.call(a, "customData") &&
                typeof a.customData !== "undefined" &&
                a.customData !== null;
            k || (a.customData = {});
            if (h) {
              k = s();
              a.customData.rex = { uid: k, retry: 0 };
            }
            if (i && g === v) {
              if (h) {
                y(e, "POST", "SB", a.customData);
                b.trigger("BEACON", e, f);
                return;
              }
              if (j(e)) {
                b.trigger("BEACON", e, f);
            ...
            if (h) {
              y(e, "POST", "formPOST", a.customData);
              b.trigger("POST", e, f);
              return;
            }
            n(e);
            ...
            h(
              ...
              [
                ...
                },
                {
                  ...
                  value: function (a) {
                    var b = 0;
                    while (b < this._params.length)
                      this._params[b].name === a
                        ? this._params.splice(b, 1)
                        : b++;
                  },
                },
                {
      ...
      return (function (a, b, c, d) {
        ...
        (function () {
          ...
          var H = A.fired,
            ...
            ja;
          b.referrer;
          var T = { PageView: new B(), PixelInitialized: new B() },
            U = new r(f, S),
            V = new y(U, M),
            ka = new B(["eid"]);
          function la(a) {
          ...
          function W() {
            try {
              var a = ha.call(arguments);
              if (M.isLocked() && a[0] !== "consent") {
          ...
          function ma(a) {
            ...
            switch (a) {
              ...
              case "autoConfig":
                ...
                U.callMethod([n, m, "AutomaticSetup"]);
                break;
              case "firstPartyCookies":
                ...
                typeof p === "string"
                  ? U.callMethod([r, p, "FirstPartyCookies"])
                  : p === void 0
                  ? (U.disableFirstPartyCookies = !0)
                  : L({
                      invalidParamName: "pixel_id",
                      invalidParamValue: p,
                      method: "set",
              ...
              case "startIWLBootstrap":
                var y = c[0],
                  z = c[1];
                ca.triggerWeakly({ graphToken: y, pixelID: z });
                break;
              case "parallelfire":
                var A = c[0],
                  B = c[1];
                U.pluginConfig.set(A, "parallelfire", { target: B });
                break;
              case "trackSingleOnly":
                ...
                break;
              default:
                var H = U.pluginConfig.getWithGlobalFallback(
                    null,
                    "dataProcessingOptions"
                  ),
          ...
          function X(a, b, c) {
            ...
            if (O.call(S, d)) {
              b != null && D(S[d].userData)
                ? ((S[d].userData = e ? b || {} : {}), V.loadPlugin("identity"))
          ...
          function sa(a, b, c, d) {
            ...
            try {
              var g = (a && a.userData) || {},
                ...
                l = void 0,
                n = g.em;
              n != null && Z(n) && ((l = Z(n)), l === 1 && (i.em = ga));
              n = h.em;
              n != null && Z(n) && ((l = Z(n)), l === 1 && (k.em = ga));
            ...
            e.append("coo", l);
            g = U.pluginConfig.getWithGlobalFallback(
              a ? a.id : null,
              "dataProcessingOptions"
            );
            if (g != null) {
          ...
          function ta() {
            while (f.queue.length && !M.isLocked()) {
              var a = f.queue.shift();
              W.apply(f, a);
            }
          }
          ...
          f.pixelId && ((Q = !0), X(f.pixelId));
          ((Q && ia) || a.fbq !== a._fbq) &&
            L({ type: "CONFLICTING_VERSIONS" });
          R.length > 1 && L({ type: "MULTIPLE_PIXELS" });
          function ua() {
          ...
          function xa() {
            return { pixelInitializationTime: N, pixels: R };
          }
          function ya(a) {
            (a.instance = U),
              (a.callMethod = W),
